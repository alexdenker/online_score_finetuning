...
import math
"""
Adapted from https://github.com/bot66/MNISTDiffusion/blob/main/unet.py#L122
...
class TinyUnet(nn.Module):
    ...
    '''
    def __init__(self,marginal_prob_std,time_embedding_dim,max_period=0.005, in_channels=3,out_channels=2,base_dim=32,dim_mults=[2,4,8,16]):
        super().__init__()
    ...
    def forward(self,x,t):
        ...
        t_emb = self.time_embed(timestep_embedding(t, self.time_embedding_dim, self.max_period))
